<section class="rounded-md text-ctp-base p-4">
  <div class="bg-gradient-to-br from-ctp-peach via-ctp-pink to-ctp-green p-8 rounded-sm flex justify-around items-center">
    ...
    <div class="inline-flex items-center">
      <div class="bg-ctp-crust text-ctp-text p-2 rounded-l-sm font-mono">
        contact@chimoteam.eu.org
      </div>
      <a href="mailto:contact@chimoteam.eu.org" class="p-2 bg-ctp-base text-ctp-text rounded-r-sm">Go</a>
    </div>
  </div>
</section>
